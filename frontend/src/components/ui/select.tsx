...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-11 w-full items-center justify-between whitespace-nowrap rounded-md border border-input bg-neutral-50 px-4 py-3 text-base shadow-sm transition-normal placeholder:text-muted-foreground focus:outline-none focus:border-brand-blue focus:bg-background focus:shadow-focus-ring disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
      className
    )}
    {...props}
  >
