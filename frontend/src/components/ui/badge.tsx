...
const badgeVariants = cva(
  "inline-flex items-center rounded-md border px-2 py-0.5 text-xs font-medium transition-colors focus:outline-none focus:shadow-focus-ring",
  {
    variants: {
      variant: {
        default: "border-transparent bg-brand-blue text-white",
        secondary: "border-transparent bg-muted text-foreground",
        trade: "border-transparent bg-brand-navy text-brand-amber",
